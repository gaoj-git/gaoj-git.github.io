...
## 关于我
1. 主业务java开发，当然其它语言也会涉javascript、html、vue、golang、c语言相关（本人近期在研究物联网相关的单片机，有所接触）,uniapp开发app以及上架安卓和ios各大应用市场。
2. 佛系开发🙂
...
<script  type="text/javascript" language="javascript">
    function siteTime(){
        ...
        var t1 = Date.UTC(2023,07,25,00,00,00); //北京时间创建网站的时间
